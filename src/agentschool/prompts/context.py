...
from agentschool.coordinator.coordinator_mode import get_coordinator_system_prompt, is_coordinator_mode
from agentschool.memory import find_relevant_memories, load_memory_prompt
from agentschool.prompts.claudemd import load_claude_md_prompt
from agentschool.prompts.system_prompt import build_system_prompt
from agentschool.skills.loader import load_skill_registry
...
def _build_delegation_section() -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "AgentSchool can delegate background work with the `agent` tool.",
