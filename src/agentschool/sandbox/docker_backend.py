...
from agentschool.config import Settings
from agentschool.platforms import get_platform, get_platform_capabilities
from agentschool.sandbox.adapter import SandboxAvailability, SandboxUnavailableError
...
class DockerSandboxSession:
    """Manages a long-running Docker container for one AgentSchool session."""
    ...
    def __post_init__(self) -> None:
        self._container_name = f"agentschool-sandbox-{self.session_id}"
    ...
    async def start(self) -> None:
        ...
        from agentschool.sandbox.docker_image import ensure_image_available
