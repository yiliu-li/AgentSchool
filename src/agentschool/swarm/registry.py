...
from agentschool.platforms import get_platform, get_platform_capabilities
from agentschool.swarm.spawn_utils import is_tmux_available
from agentschool.swarm.types import BackendDetectionResult, BackendType, TeammateExecutor
...
class BackendRegistry:
    ...
    def get_executor(self, backend: BackendType | None = None) -> TeammateExecutor:
        ...
        Returns:
            The registered :class:`~agentschool.swarm.types.TeammateExecutor`.
    ...
    def get_preferred_backend(self, config: dict | None = None) -> BackendType:
        ...
        if config:
            ...
            mode = os.environ.get("AGENTSCHOOL_TEAMMATE_MODE", "auto")
    ...
    def _register_defaults(self) -> None:
        ...
        if get_platform_capabilities().supports_swarm_mailbox:
            from agentschool.swarm.in_process import InProcessBackend
