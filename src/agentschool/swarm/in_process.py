...
* :class:`InProcessBackend` – implements
  :class:`~agentschool.swarm.types.TeammateExecutor` and manages the dict of
  live asyncio Tasks.
"""
...
async def start_in_process_teammate(
    *,
    ...
    2. Drives the query engine loop (reusing
       :func:`~agentschool.engine.query.run_query`).
    ...
    query_context:
        Optional pre-built
        :class:`~agentschool.engine.query.QueryContext`.  When *None* this
...
async def _run_query_loop(
    ...
    """Drive :func:`~agentschool.engine.query.run_query` until done or cancelled.
...
class InProcessBackend:
    ...
    async def send_message(self, agent_id: str, message: TeammateMessage) -> None:
        ...
        from agentschool.swarm.mailbox import MailboxMessage
