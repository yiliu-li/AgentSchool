"""Credential storage for AgentSchool.

Default backend: ~/.agentschool/credentials.json with mode 600.
...
def _obfuscation_key() -> bytes:
    ...
    seed = str(Path.home()).encode() + b"agentschool-v1"
    import hashlib
