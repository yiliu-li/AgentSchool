...
class ApiKeyFlow(AuthFlow):
    """Prompt the user for an API key and persist it via :mod:`agentschool.auth.storage`."""
...
class DeviceCodeFlow(AuthFlow):
    ...
    def __init__(
        ...
        *,
        ...
        from agentschool.api.copilot_auth import COPILOT_CLIENT_ID
    ...
    def run(self) -> str:
        from agentschool.api.copilot_auth import poll_for_access_token, request_device_code
