...
from agentschool.api.client import ApiMessageCompleteEvent, ApiMessageRequest, SupportsStreamingMessages
...
from agentschool.sandbox import SandboxUnavailableError
...
class HookExecutor:
    ...
    async def _run_command_hook(
        ...
        try:
            process = await create_shell_subprocess(
                ...
                env={
                    **os.environ,
                    "AGENTSCHOOL_HOOK_EVENT": event.value,
                    "AGENTSCHOOL_HOOK_PAYLOAD": json.dumps(payload),
                },
            )
    ...
    async def _run_prompt_like_hook(
        ...
        *,
        ...
        prefix = (
            "You are validating whether a hook condition passes in AgentSchool. "
