"""Agent definition loading system for AgentSchool."""
...
def get_all_agent_definitions() -> list[AgentDefinition]:
    ...
    1. Built-in agents
    2. User agents (~/.agentschool/agents/)
    ...
    try:
        from agentschool.plugins.loader import load_plugins  # noqa: PLC0415
        from agentschool.config.settings import load_settings  # noqa: PLC0415
