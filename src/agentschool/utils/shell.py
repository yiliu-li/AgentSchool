...
from agentschool.config import Settings, load_settings
from agentschool.platforms import PlatformName, get_platform
from agentschool.sandbox import wrap_command_for_sandbox
...
async def create_shell_subprocess(
    ...
    *,
    ...
    if resolved_settings.sandbox.enabled and resolved_settings.sandbox.backend == "docker":
        from agentschool.sandbox.session import get_docker_sandbox
