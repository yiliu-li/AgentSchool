...
from agentschool.engine.messages import ConversationMessage, assistant_message_from_api
...
def _translate_api_error(exc: APIError) -> AgentSchoolApiError:
