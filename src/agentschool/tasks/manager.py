...
from agentschool.config.paths import get_tasks_dir
...
_TASK_RESTART_NOTICE = "[AgentSchool] Agent task restarted; prior interactive context was not preserved.\n"
    ...
    async def create_agent_task(
        ...
        *,
        ...
        if command is None:
            ...
            cmd = ["python", "-m", "agentschool", "--api-key", effective_api_key]
            if model:
