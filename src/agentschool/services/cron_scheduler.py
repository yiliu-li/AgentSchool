...
Runs as a standalone process (``agentschool cron start``) or can be embedded via
...
from agentschool.config.paths import get_data_dir, get_logs_dir
from agentschool.services.cron import (
    load_cron_jobs,
    mark_job_run,
...
# ---------------------------------------------------------------------------
# Daemon entry point (spawned by ``agentschool cron start``)
# ---------------------------------------------------------------------------
