...
from agentschool.services import session_storage
...
class AgentSchoolSessionBackend:
    """Default session backend backed by ``~/.agentschool/data/sessions``."""
...
DEFAULT_SESSION_BACKEND: SessionBackend = AgentSchoolSessionBackend()
