...
from agentschool.themes.builtin import BUILTIN_THEMES
from agentschool.themes.schema import ThemeConfig
...
def get_custom_themes_dir() -> Path:
    ...
    path = Path.home() / ".agentschool" / "themes"
    path.mkdir(parents=True, exist_ok=True)
    return path


def load_custom_themes() -> dict[str, ThemeConfig]:
    """Load custom themes from ~/.agentschool/themes/*.json."""
