...
from agentschool.ui.runtime import build_runtime, close_runtime
...
async def test_build_runtime_registers_enabled_plugin_tools(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr("agentschool.ui.runtime.load_settings", lambda: Settings(allow_project_plugins=True))
