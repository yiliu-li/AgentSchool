...
from agentschool.swarm.in_process import (
    InProcessBackend,
    TeammateContext,
    get_teammate_context,
    set_teammate_context,
)
from agentschool.swarm.types import TeammateMessage, TeammateSpawnConfig
...
async def test_send_message_writes_to_mailbox(backend, tmp_path, monkeypatch):
    ...
    from agentschool.swarm.mailbox import TeammateMailbox
